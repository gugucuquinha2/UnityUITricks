...
public class NavBar_Ex2 : MonoBehaviour
{
    [Header("-- CONTAINERS --")]
    [SerializeField]
    ...
    /// <summary>
    /// Set and declare variables at the beginning of the script.
    /// </summary>
    private void SetDefaultVars()
    {
        ...
        selectedImgPosY = -menuImgs[0].rectTransform.rect.height * 0.125f;
        selectedIconDefPosY = 0;

        // selected icon position and size
        selectionIcon.anchoredPosition = new Vector2(menuBtns[0].anchoredPosition.x, selectedIconDefPosY);
        selectionIcon.sizeDelta = new Vector2(menuBtns[0].sizeDelta.x, selectionIcon.sizeDelta.y);
